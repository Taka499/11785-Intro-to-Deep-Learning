...
class AdamW():
    ...
    def step(self):
        ...
        for layer_id, layer in enumerate(self.l):
            ...
            layer.W = layer.W - self.lr * m_W / np.sqrt(v_W + self.eps) - self.lr * self.weight_decay * layer.W
            layer.b = layer.b - self.lr * m_b / np.sqrt(v_b + self.eps) - self.lr * self.weight_decay * layer.b
